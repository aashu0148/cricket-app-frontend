...
export default function EditScoringSystem() {
  ...
  function handleAddition({ field, section, setFunction }) {
    ...
    newObject._id =
      Date.now().toString(16) - Math.floor(Math.random() * 10000).toString(16);
    ...
    return (
      <div className={styles.section}>
        ...
        <div className={styles.subSection}>
          ...
          {/* ************************************ Boundary Points ****************************** */}
          {data.boundaryPoints.map((boundary, index) => (
        ...
        <div className={styles.subSection}>
          ...
          {data.runMilestoneBonus.milestones.map((milestone, index) => (
  ...
  return !scoringData ? (
    ...
    <div className={`page-container ${styles.container}`}>
      ...
      {/* Batting Section */}
      <BattingSection data={battingData} />

      {/* Bowling Section */}
      <BowlingSection data={bowlingData} />

      {/* Fielding Section */}
      <FieldingSection data={fieldingData} />
